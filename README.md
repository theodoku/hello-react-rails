 ...
 **Set-up-a-Hello-world-project-as-one-app-with-Webpack**  In this exercise, I use my previous knowledge in Webpack with jsbundling-rails gem.
...
```
$ git clone https://github.com/theodoku/hello-react-rails.git
```
...
- GitHub: [@theodokuJ](https://github.com/theodoku)
- Twitter: [@dok_theo](https://https://twitter.com/dok_theo)
- LinkedIn: [Theophilus-Doku](https://www.linkedin.com/in/theophilus_doku/)
